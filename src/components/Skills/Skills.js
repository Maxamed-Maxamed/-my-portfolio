...
const skillsData = [
  {
    ...
    skills: [
      ...
      { name: 'HTML/CSS', imgUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/HTML5_logo_and_wordmark.svg/1024px-HTML5_logo_and_wordmark.svg.png' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'PyTest', imgUrl: 'https://pytest.org/img/pytest.svg' },
      { name: 'Selenium', imgUrl: 'https://www.selenium.dev/images/selenium_logo_square_green.png' },
    ],
  },
];
