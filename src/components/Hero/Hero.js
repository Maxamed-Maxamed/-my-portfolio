...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white p-12 mt-16"
      aria-label="Hero section"
    >
      {/* Left Side Text */}
      <div className="flex-1 max-w-lg text-center md:text-left space-y-8">
